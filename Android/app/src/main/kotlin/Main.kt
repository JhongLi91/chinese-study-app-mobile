...
internal val logger: SkipLogger = SkipLogger(subsystem = "chinese.study.app", category = "ChineseStudyApp")

private typealias AppRootView = ChineseStudyAppRootView
private typealias AppDelegate = ChineseStudyAppAppDelegate
